 ...
 */
class PlayerSecondFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var sendDataFromFragment: PlayerSendDataFromF2? = null
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_player_second, container, false)
    ...
    interface PlayerSendDataFromF2 : PlayerFirstFragment.PlayerSendDataFromF1 {
        fun playerSendDataSecondFragment(
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            sendDataFromFragment = activity as PlayerSendDataFromF2?
    ...
    override fun onPause() {
        super.onPause()
        if(!emptyCheck()){
            sendDataFromFragment?.playerSendDataSecondFragment(spinGender.selectedItem.toString(),
